...
TEST_CASES = {
    ...
    # Boé, not Agen itself: addresses within Agen's own city center fall under
    # a "multiple" sectorization sub-service this source doesn't resolve and
    # return zero collections; other communes of the agglomeration work fine.
    "Agglo d'Agen, Boé": {
